...
import upeu.edu.pe.calcjps.ui.theme.CalcJPSTheme
import upeu.edu.pe.calcjps.ui.theme.Purple200
import upeu.edu.pe.calcjps.ui.theme.textColor
                ...
                .clickable(
                    ...
                    onClick = {
                        ...
                        if (valuex.equals("+") || valuex.equals("-") || valuex.equals("*") || valuex.equals(
                                "/"
                            ) || valuex.equals("%") || valuex.equals("^") || valuex.equals("√") || valuex.equals("π")
                        ) {
                        ...
                        if (valuex.equals("=")) {
                            if (oldTextState.isNotEmpty()) {
                                ...
                                when (op) {
                                    ...
                                    "√" -> {
                                        finalNumber = Math.sqrt(textState.toDouble())
                                    }
